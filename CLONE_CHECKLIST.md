...
|---|---|---|
| New domain | GoDaddy / purchase | `cavecreekhomesforsale.com` |
...
git remote set-url origin https://github.com/aiagent322/cave-creek-homes-for-sale
...
| Find | Replace with |
|---|---|
| `wickenburghorseproperty.com` | `cavecreekhomesforsale.com` |
| `wickenburg-horse-property.pages.dev` | `cave-creek-homes-for-sale.pages.dev` |
| `aiagent322/wickenburg-horse-property` | `aiagent322/cave-creek-homes-for-sale` |
...
"url": "https://cavecreekhomesforsale.com/",
...
2. Connect to new GitHub repo (`aiagent322/cave-creek-homes-for-sale`)
